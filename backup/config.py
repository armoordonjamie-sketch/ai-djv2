...
OPENROUTER_ONBOARD_MODEL: str = os.getenv("OPENROUTER_ONBOARD_MODEL", "google/gemini-2.0-flash-001")
...
# =============================================================================
# LangGraph v3 Orchestration
# =============================================================================
USE_LANGGRAPH_V3: bool = os.getenv("USE_LANGGRAPH_V3", "false").lower() == "true"
LANGGRAPH_CHECKPOINTER: str = os.getenv("LANGGRAPH_CHECKPOINTER", "memory")
LANGGRAPH_STORE: str = os.getenv("LANGGRAPH_STORE", "memory")
LANGGRAPH_RAG_ENABLED: bool = os.getenv("LANGGRAPH_RAG_ENABLED", "true").lower() == "true"
