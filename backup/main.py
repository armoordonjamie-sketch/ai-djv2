...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    # Log LangGraph v3 orchestration status
    if USE_LANGGRAPH_V3:
        logger.info("🧠 LangGraph v3 orchestration ENABLED")
    else:
        logger.info("⚙️  Using v2 orchestration (set USE_LANGGRAPH_V3=true for v3)")
