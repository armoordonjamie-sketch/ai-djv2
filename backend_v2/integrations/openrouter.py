...
def get_track_duration_sec(track: Dict[str, Any]) -> float:
    ...
    Args:
        track: Track dict with duration_sec, duration, or local_path
...
class OpenRouterClient:
    ...
    def __init__(self):
        ...
        # NOTE: Using paid model due to rate limits on free tier
        self.model = "google/gemini-2.0-flash-001"
        # Use paid model for all tasks (free tier has rate limits)
        self.model_lite = "google/gemini-2.0-flash-001"
