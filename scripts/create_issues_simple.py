"""Simple script to create GitHub issues from docs/issues.md.

This will create all 9 issues documented in docs/issues.md.
...
# Issues data from docs/issues.md
ISSUES = [
    {
...
def main():
    ...
    print("=" * 60)
    print()
    print(f"This will create {len(ISSUES)} issues in {REPO}")
    print()
    ...
    token = input("Paste your GitHub token (or press Enter to exit): ").strip()
